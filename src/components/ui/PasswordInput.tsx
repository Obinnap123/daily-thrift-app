 ...
 * ----------------------------------------------------------------------------
 * Same label/error/props contract as <Input>, but renders an eye/eye-slash
 * button inside the field that toggles between type="password" (masked,
 * the default) and type="text" (visible) — lets a user confirm what they
 * typed before submitting, without permanently storing or logging the
 * plain-text value anywhere.
 */
